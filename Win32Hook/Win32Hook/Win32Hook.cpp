                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_WIN32HOOK, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WIN32HOOK));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WIN32HOOK));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_WIN32HOOK);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
	{
		MessageBox(0, TEXT("HOOK KeyBoard"), TEXT("HOOK"), MB_OK);
	}
	break;
	case WM_CREATE:
		//安装鼠标钩子
	...
	break;
	case WM_LBUTTONDOWN:
		MessageBox(hWnd, TEXT("LBUTTONDOWN"), TEXT("NOTE"), MB_OK);
		break;
    case WM_COMMAND:
        {
